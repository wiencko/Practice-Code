...
void trace_path(int remaining_weight, int item, std::set<int> current_set, std::set<int> remaining_items, std::set<std::set<int> >& answers, std::vector<std::vector<int> > weights);
